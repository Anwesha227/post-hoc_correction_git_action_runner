...
OUTPUT_CSV="${SCRIPT_DIR}/../mllm_output/nebius_${BASE_MODEL}_Qwen_Qwen2.5-VL-72B-Instruct_qwen_top5_grouped.csv"
ERROR_LOG="${SCRIPT_DIR}/../mllm_output/nebius_${BASE_MODEL}_Qwen_Qwen2.5-VL-72B-Instruct_qwen_top5_grouped_errors.txt"
...
"${SCRIPT_DIR}/run_qwen.sh" \
  --backend nebius \
  --python "${SCRIPT_DIR}/../qwen_top5_grouped.py" \
